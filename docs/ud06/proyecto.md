# 3ESO-UD06-P01 · Proyecto · Juego o miniaplicación de texto

## Encargo

Integra lo aprendido en introducción a python mediante un producto útil para una situación académica o cotidiana. Debes reutilizar o mejorar evidencias de las actividades, tomar decisiones propias y demostrar que el resultado ha sido probado.
...
6. Entregar en la tarea **3ESO-UD06-P01** de Aules el producto, el editable, las fuentes y la reflexión.

## Nombre de entrega

`3ESO-UD06-P01-ApellidoNombre-v01`
